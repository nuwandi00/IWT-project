...
<head>
    ...
    <link rel="stylesheet" href="../css/headerfooter(contactuspage).css">
...
<body>
	...
	<div class="header-3">
		...
		<div>
		<img src="../images/background.png" height="300px" width="1910px">
		</div>
...
<div class="header-4">
	...
	<h1 style="font-size:30px; text-align:center;"> CONTACT US</h1><br>
	<p style="font-size:16px; text-align:center; color:red;">While we are good with supermarket side, there are simpler ways for us to get in touch and answer your questions.</p>
	<br>
	<hr style="border:3px solid green;">
	<br>
	<form method="POST" action="insertcontactus.php" align="center" style="background-image:url('../images/formbackground.webp'); padding:10px;">
		<input type="text1"  placeholder="First Name" name="firstName" required><br><br><br><br>
		<input type="text1"  placeholder="Last Name" name="lastName" required><br><br><br><br>
		<input type="email"  placeholder="Email" name="email" required><br><br><br><br>
		<textarea id="message" rows="10" cols="75" placeholder="  Your Message..." name="message"></textarea><br><br><br><br>
