...
<head>
    ...
    <title>Foodigo.com/Delivery</title>
...
<div class="header-4">
	...
	<div class="mydiv"><br><br>
        <center>
        <button class="mybt"><a href="http://localhost/OnlineCustomerSupportSystem/php/delivery.php"><span>Delivery</span></a></button>
        <button class="mybt"><a href="http://localhost/OnlineCustomerSupportSystem/php/pickup.php"><span>Pick-up</span></a></button></center><br><br><br>

        <div class="div2">
        <form class="form1" method="post" action="deliverydata.php">
            <label for="uname">Name:</label>
            <input type="text" class="textarea1"  placeholder="Enter Your name" name="uname"required>
            <label>Address:</label>
            <input type="text" class="textarea1" placeholder="Enter Your Address" name="Address"required>
            <label >Phone Number:</label>
            <input type="number" class="textarea1" placeholder="Enter Your phone number" name="pnumber" required>
             
             <br>
            
            <center><br>
                            
            <label>Schedule</label><input type="date" name="schedule"class="textarea1" placeholder="MM/DD/YYYY"></center></div>
       

 
<div class="div3">
<center>
<button class="mybt2" type="submit">Save</button>
<button class="mybt2" type="reset">Change</button></form>
<br><br>
    
    <b class="thanks">Thanks for being with us!!!</b></center>
</div>
